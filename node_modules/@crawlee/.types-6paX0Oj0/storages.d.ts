...
export interface DatasetClient<Data extends Dictionary = Dictionary> {
    ...
    listEntries?(options?: DatasetClientListOptions): AsyncIterable<[number, Data]> & Promise<PaginatedList<[number, Data]>>;
...
export interface KeyValueStoreClient {
    ...
    delete(): Promise<void>;
    listKeys(options?: KeyValueStoreClientListOptions): Partial<AsyncIterable<KeyValueStoreItemData>> & Promise<KeyValueStoreClientListData>;
